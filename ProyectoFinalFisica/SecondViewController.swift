...
class SecondViewController: UIViewController {
    ...
    func updateQuestion(){
        ...
        if questionNumber <= allQuestions.list.count - 1{
            ...
            let alert = UIAlertController(title: "¡Felicidades!", message: "Final de Quiz. ¿Quieres volverlo a contestar?", preferredStyle: .alert)
            let restartAction = UIAlertAction(title: "Volver a practicar", style: .default, handler: {action in self.restartQuiz()})
